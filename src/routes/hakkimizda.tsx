...
function HakkimizdaPage() {
  ...
  const startupMarketUrl =
    "https://startupmarket.co/stajyer-bul-hizli-ve-kolay-staj-eslestirme-platformu";
      ...
      <main className="flex-1 container-x py-12 max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-base max-w-2xl mx-auto">
            ...
            kolaylaştırmak için yola çıkan yenilikçi bir girişim platformuyuz.
          </p>
        </div>
          ...
          <div className="relative w-full max-w-lg rounded-2xl border border-border bg-card p-6 md:p-8 shadow-2xl space-y-6">
            ...
            <div className="space-y-2 text-center">
              ...
              <p className="text-xs text-muted-foreground">
                StajyerBul projesine destek olmak, yatırım yapmak veya işbirliği kurmak için
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="p-4 rounded-xl border border-amber-500/30 bg-amber-500/5 space-y-2">
                <span className="text-xs font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wider">
                  Startup Market Profilimiz
                </span>
                <p className="text-xs text-muted-foreground">
                  Girişimimizin tüm detaylarını, hedeflerini ve aşamalarını Startup Market üzerinden
                  inceleyebilirsiniz:
                </p>
                <div className="pt-1">
                  <a
