...
export const STATIC_BLOG_POSTS: EditorialBlogPost[] = [
  post({
    ...
    excerpt:
      "2027 MESEM ücretleri henüz açıklanmadı. Mevcut oranlarla olası tutarları ve kesin maaşın nasıl hesaplanacağını inceleyin.",
    category: "Sektör Haberleri",
    seo_title: "2027 MESEM Maaşları Ne Kadar Olacak?",
    seo_description:
      "2027 MESEM maaşı henüz kesinleşmedi. Çırak ve 12. sınıf kalfa ücretlerini yüzde 30 ve yüzde 50 oranlarıyla senaryolu hesapladık.",
...
Son güncelleme: 15 Eylül 2026. Resmî tutar açıklandığında bu yazı güncellenecektir.`,
  ...
  post({
    ...
    excerpt:
      "2027 staj ücretinin hangi kurala göre hesaplanacağını, öğrenci türüne ve işletmeye göre değişebilen noktaları öğrenin.",
    category: "Sektör Haberleri",
    seo_title: "2027 Stajyer Maaşı Ne Kadar Olacak?",
    seo_description:
      "2027 stajyer maaşı henüz açıklanmadı. Mevcut kuralları, net asgari ücret bağlantısını ve hesaplama yöntemini anlattık.",
